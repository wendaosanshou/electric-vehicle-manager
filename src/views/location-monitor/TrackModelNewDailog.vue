<template>
  <div class="filing-lose-dialog">
    <el-dialog class="dialog-fix dialog-container" title="追踪模式" width="430px" :visible.sync="dialogVisible" @close="onDialogHide">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button class="btn-confirm" size="mini" type="primary" @click="onDialogConfirm">设置</el-button>
      </div>
    </el-dialog>
  </div>
</template>

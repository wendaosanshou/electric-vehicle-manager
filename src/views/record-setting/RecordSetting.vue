  ...
  <div class="page-record-setting">
    ...
    <div class="record-setting-container">
      <div class="setting-time setting-part-container">
        <div class="setting-label">预约时间</div>
      ...
      <div class="setting-owner-info setting-part-container">
        <div class="setting-label">车主信息</div>
        <div class="setting-content">
          <el-row :gutter="20">
            <el-col :span="6">
              <div class="item-selector-wraper">
      ...
      <div class="setting-vehicle-info setting-part-container">
        <div class="setting-label">车辆信息</div>
        <div class="setting-content">
          <el-row :gutter="20">
            <el-col :span="6">
              <div class="item-selector-wraper">
      ...
      <div class="setting-picture-info setting-part-container">
        <div class="setting-label">照片信息</div>
        <div class="setting-content">
          <el-upload
            size="mini"
      ...
      <div class="setting-processing-process setting-part-container">
        <div class="setting-label">业务办理流程</div>
        <div class="setting-content">
          <div class="box-card">
      ...
      <div class="setting-part-container">
        <div class="el-btn btn-save">保存</div>
      </div>
    </div>
  </div>
</template>

<template>
  <div class="page-record">
    <div class="record-menu-container">
      <el-row :gutter="20">
        <el-col class="menu-col-less" :span="4">
        ...
        <el-col class="menu-col-less" :span="5">
          <div class="item-selector-wraper">
            <div class="item-label">县区</div>
            <el-select class="item-selector" size="mini" v-model="countyArea" placeholder="请选择">
              <el-option
        ...
        <el-col class="menu-col-less" :span="6">
          <div class="item-selector-wraper">
        ...
        <el-col class="menu-col-more" :span="4">
          <div class="item-selector-wraper">
    ...
    <div class="record-btn-contanier">
      ...
      <div class="btn-right-container">
        <div class="btn-right-label color-primary" v-if="isRecordInfoManage">
          请点击手机号码进行修改
        </div>
    ...
    <el-table class="table-fix" :data="tableData" size="mini" border stripe style="width: 100%">
      ...
      <el-table-column label="车主手机号" width="180" align="center">
          <template slot-scope="scope">
            <el-tooltip class="item" effect="dark" content="点击修改信息" placement="top" v-if="isRecordInfoManage">
              <div class="table-mobile" @click="onMobileSetting">{{scope.row.mobile}}</div>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="查询办理详情" placement="top" v-else-if="isProcessManage">
